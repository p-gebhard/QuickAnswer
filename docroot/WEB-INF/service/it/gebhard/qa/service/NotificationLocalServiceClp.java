 ...
 */
public class NotificationLocalServiceClp implements NotificationLocalService {
	public NotificationLocalServiceClp(
		...
		_methodName19 = "getNotificationsForUser";

		_methodParameterTypes19 = new String[] { "com.liferay.portal.model.User" };

		_methodName20 = "getNotificationsForUserId";
	...
	public it.gebhard.qa.model.Notification addNotification(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(notification) });
		}
		catch (Throwable t) {
		...
		return (it.gebhard.qa.model.Notification)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.gebhard.qa.model.Notification createNotification(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { notificationId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.gebhard.qa.model.Notification deleteNotification(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { notificationId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.gebhard.qa.model.Notification fetchNotification(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { notificationId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.gebhard.qa.model.Notification getNotification(long notificationId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { notificationId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.gebhard.qa.model.Notification> getNotifications(
		...
		return (java.util.List<it.gebhard.qa.model.Notification>)ClpSerializer.translateOutput(returnObj);
	}
