...
/**
 * The interface for the Notification local service.
 *
 * <p>
...
public interface NotificationLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NotificationLocalServiceUtil} to access the Notification local service. Add custom service methods to {@link it.gebhard.qa.service.impl.NotificationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
