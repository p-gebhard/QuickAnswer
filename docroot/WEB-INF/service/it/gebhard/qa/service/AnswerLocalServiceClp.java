...
public class AnswerLocalServiceClp implements AnswerLocalService {
	...
	public it.gebhard.qa.model.Answer addAnswer(
		...
		return (it.gebhard.qa.model.Answer)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.gebhard.qa.model.Answer createAnswer(long answerId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { answerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.gebhard.qa.model.Answer deleteAnswer(long answerId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { answerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.gebhard.qa.model.Answer fetchAnswer(long answerId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { answerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.gebhard.qa.model.Answer getAnswer(long answerId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { answerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.gebhard.qa.model.Answer> getAnswers(int start,
		...
		return (java.util.List<it.gebhard.qa.model.Answer>)ClpSerializer.translateOutput(returnObj);
	}
