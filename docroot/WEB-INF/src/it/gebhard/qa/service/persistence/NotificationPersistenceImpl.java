...
import it.gebhard.qa.NoSuchNotificationException;
import it.gebhard.qa.model.Notification;
import it.gebhard.qa.model.impl.NotificationImpl;
import it.gebhard.qa.model.impl.NotificationModelImpl;
...
public class NotificationPersistenceImpl extends BasePersistenceImpl<Notification>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(NotificationModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERID =
		new FinderPath(NotificationModelImpl.ENTITY_CACHE_ENABLED,
			...
			NotificationModelImpl.USERID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(NotificationModelImpl.ENTITY_CACHE_ENABLED,
	...
	protected Notification removeImpl(Notification notification)
		...
		try {
			...
			BatchSessionUtil.delete(session, notification);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public Notification updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, notification, merge);
		...
		if (isNew || !NotificationModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((notificationModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(notificationModelImpl.getOriginalUserId())
					};
				...
				args = new Object[] {
						Long.valueOf(notificationModelImpl.getUserId())
					};
	...
	protected Notification toUnwrappedModel(Notification notification) {
		...
		notificationImpl.setQuestionId(notification.getQuestionId());
		notificationImpl.setAnswerId(notification.getAnswerId());
	 ...
	 * @throws com.liferay.portal.NoSuchModelException if a Notification with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	public Notification findByPrimaryKey(long notificationId)
		throws NoSuchNotificationException, SystemException {
		Notification notification = fetchByPrimaryKey(notificationId);
	...
	public Notification fetchByPrimaryKey(long notificationId)
		...
		Notification notification = (Notification)EntityCacheUtil.getResult(NotificationModelImpl.ENTITY_CACHE_ENABLED,
				NotificationImpl.class, notificationId);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Notification findByUserId_First(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchNotificationException, SystemException {
		Notification notification = fetchByUserId_First(userId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Notification fetchByUserId_First(long userId,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Notification findByUserId_Last(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchNotificationException, SystemException {
		Notification notification = fetchByUserId_Last(userId, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Notification fetchByUserId_Last(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByUserId(userId);

		List<Notification> list = findByUserId(userId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Notification[] findByUserId_PrevAndNext(long notificationId,
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(session, notification, userId,
					orderByComparator, true);

			array[1] = notification;

			array[2] = getByUserId_PrevAndNext(session, notification, userId,
	...
	protected Notification getByUserId_PrevAndNext(Session session,
		Notification notification, long userId,
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.it.gebhard.qa.model.Notification")));
	...
	private static final String _FINDER_COLUMN_USERID_USERID_2 = "notification.userId = ?";
