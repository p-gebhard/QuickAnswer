...
/**
 * The base implementation of the Vote local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.gebhard.qa.service.impl.VoteLocalServiceImpl}.
 * </p>
 *
...
public abstract class VoteLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VoteLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.gebhard.qa.service.VoteLocalServiceUtil} to access the Vote local service.
	 */
	...
	public Vote addVote(Vote vote) throws SystemException {
		vote.setNew(true);

		return votePersistence.update(vote, false);
	}
	...
	public Vote deleteVote(long voteId) throws PortalException, SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Vote deleteVote(Vote vote) throws SystemException {
	...
	public Vote fetchVote(long voteId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Vote getVote(long voteId) throws PortalException, SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Vote> getVotes(int start, int end) throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Vote updateVote(Vote vote) throws SystemException {
		return updateVote(vote, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Vote updateVote(Vote vote, boolean merge) throws SystemException {
		vote.setNew(false);

		return votePersistence.update(vote, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("it.gebhard.qa.model.Vote",
			voteLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.gebhard.qa.model.Vote");
	}
	...
	private VoteLocalServiceClpInvoker _clpInvoker = new VoteLocalServiceClpInvoker();
}