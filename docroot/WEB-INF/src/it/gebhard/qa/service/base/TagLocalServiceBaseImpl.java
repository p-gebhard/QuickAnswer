...
/**
 * The base implementation of the Tag local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.gebhard.qa.service.impl.TagLocalServiceImpl}.
 * </p>
 *
...
public abstract class TagLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.gebhard.qa.service.TagLocalServiceUtil} to access the Tag local service.
	 */
	...
	public Tag addTag(Tag tag) throws SystemException {
		...
		return tagPersistence.update(tag, false);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Tag updateTag(Tag tag, boolean merge) throws SystemException {
		tag.setNew(false);

		return tagPersistence.update(tag, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("it.gebhard.qa.model.Tag",
			tagLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.gebhard.qa.model.Tag");
	}
