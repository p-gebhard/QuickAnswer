...
/**
 * The base implementation of the GuestUser local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.gebhard.qa.service.impl.GuestUserLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class GuestUserLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements GuestUserLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.gebhard.qa.service.GuestUserLocalServiceUtil} to access the GuestUser local service.
	 */
	...
	public GuestUser addGuestUser(GuestUser guestUser)
		throws SystemException {
		guestUser.setNew(true);

		return guestUserPersistence.update(guestUser, false);
	}
	 ...
	 */
	public GuestUser createGuestUser(long guestUserId) {
		return guestUserPersistence.create(guestUserId);
	}
	...
	public GuestUser deleteGuestUser(long guestUserId)
		throws PortalException, SystemException {
		return guestUserPersistence.remove(guestUserId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public GuestUser deleteGuestUser(GuestUser guestUser)
		throws SystemException {
		return guestUserPersistence.remove(guestUser);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(GuestUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return guestUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return guestUserPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return guestUserPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public GuestUser fetchGuestUser(long guestUserId) throws SystemException {
		return guestUserPersistence.fetchByPrimaryKey(guestUserId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public GuestUser getGuestUser(long guestUserId)
		throws PortalException, SystemException {
		return guestUserPersistence.findByPrimaryKey(guestUserId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return guestUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<GuestUser> getGuestUsers(int start, int end)
		throws SystemException {
		return guestUserPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getGuestUsersCount() throws SystemException {
		return guestUserPersistence.countAll();
	}
	...
	public GuestUser updateGuestUser(GuestUser guestUser)
		throws SystemException {
		return updateGuestUser(guestUser, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public GuestUser updateGuestUser(GuestUser guestUser, boolean merge)
		throws SystemException {
		guestUser.setNew(false);

		return guestUserPersistence.update(guestUser, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("it.gebhard.qa.model.GuestUser",
			guestUserLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.gebhard.qa.model.GuestUser");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = guestUserPersistence.getDataSource();
	...
	private GuestUserLocalServiceClpInvoker _clpInvoker = new GuestUserLocalServiceClpInvoker();
}